document.addEventListener('DOMContentLoaded', () => {
    ...
    const GAS_API_URL = 'https://script.google.com/macros/s/AKfycbwACezWGvI4QobHeufsECC1XdCbGtmUYm1x0ZgcMjY24rMx6_I3BfVJqMoAyTwijs4O_g/exec';
...
`;
    ...
    const openStudentHistoryModal = () => {
        ...
        sortedIds.forEach(id => {
            ...
            const li = document.createElement('li');
            li.style.cssText = 'padding: 10px; cursor: pointer; border-bottom: 1px solid #f7fafc; transition: background 0.2s; font-size: 0.9rem;';
            li.innerHTML = `
                <div style="font-weight:bold; color:#2d3748;">${info.name}</div>
                <div style="font-size:0.8rem; color:#718096;">${id}</div>
            `;
