document.addEventListener('DOMContentLoaded', () => {
    ...
    // Helper: Calculate End Time (15 min after start)
    ...
    const renderScheduleList = (dateStr) => {
        ...
        // 1. Analyze Status for Each Slot
        const slotStatuses = timeSlots.map(slot => {
            ...
            let label = '予約受付停止中';
            let resData = null;
            let sortKey = 0; // For secondary sort if needed
            ...
            if (!isOpen) {
                ...
                if (hasPrivate) {
                    ...
                    label = names;
                    // For logic, we use the first res for ID/Timestamp if picking
                    resData = resInSlot[0];
                }
            } else {
                type = 'available';
        ...
        groups.forEach(g => {
            ...
            dailyScheduleList.appendChild(groupDiv);
        });
